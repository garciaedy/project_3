...
router.get('/api/users/:userId/categories/:categoriesId', categoryController.show)
router.post('/api/users/:userId/categories', categoryController.create)
router.patch('/api/users/:userId/categories/:categoriesId', categoryController.update)
router.delete('/api/users/:userId/categories/:categoriesId',categoryController.delete)
