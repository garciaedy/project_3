...
router.get('/api/users/:userId/category', categoryController.index)
router.get('/api/users/:userId/category/:categoryId', categoryController.show)
router.post('/api/users/:userId/category', categoryController.create)
router.patch('/api/users/:userId/category/:categoryId', categoryController.update)
router.delete('/api/users/:userId/category/:categoryId',categoryController.delete)
