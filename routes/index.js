...
router.get('/api/user/:userId/category/categoryId', categoryController.show)
router.post('/api/user/:userId/category', categoryController.create)
router.patch('/api/user/:userId/category/:categoryId', categoryController.update)
router.delete('/api/user/:userId/category/:categoryId',categoryController.delete)
